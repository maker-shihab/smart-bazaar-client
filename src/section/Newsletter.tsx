      ...
      <div className="2xl:mx-auto 2xl:container mx-4 py-16">
        <div className="w-full relative flex items-center justify-center">
          ...
          <div className="bg-blue-950/80 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-10">
            ...
            <p className="text-base leading-normal text-center text-white max-w-xl mt-6 mx-auto">
              Subscribe to our newsletter and never miss out! We send updates
              every Friday — packed with the latest news, exclusive deals, and
              more.
            </p>
            <div className="sm:border border-white flex-col sm:flex-row flex items-center lg:w-5/12 w-full mt-12 space-y-4 sm:space-y-0">
              ...
              />
              <button className="focus:outline-none focus:ring-offset-2 focus:ring border border-white sm:border-transparent w-full sm:w-auto bg-white py-4 px-6 hover:bg-opacity-75 text-blue-950 font-bold">
                Subscribe
              </button>
            </div>
          </div>
